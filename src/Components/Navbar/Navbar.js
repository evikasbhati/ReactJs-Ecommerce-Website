        ...
        <div>
            ...
            <div className="navbar_box">
                ...
                <div className="account">
                      ...
                      <Link to='/login'>  <button className="select_logs">Login</button></Link>
                       <Link to="/Register"> <button className="select_logs">SignUp</button></Link>
                        </div>
                ...
                <Link to='/Admin'><button className="person_button" ><Person/></button></Link>
                </div>
            </div>
        </div>
    )
